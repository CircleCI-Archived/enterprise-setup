...
apt-cache policy | grep circle || curl https://s3.amazonaws.com/circleci-enterprise/provision-builder-lxc-2016-12-05.sh | bash
curl https://s3.amazonaws.com/circleci-enterprise/init-builder-lxc-2016-12-05.sh | \
